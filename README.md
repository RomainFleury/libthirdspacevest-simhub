...
- `misc-documentations/` — curated documentation, assets, and legacy bHaptics references (e.g., Alyx mod README, illustrative images). Nothing here is built or shipped, but it provides design/reference material for future work.
