...
namespace ThirdSpace_SuperhotVR
{
    ...
    public class DaemonClient : IDisposable
    {
        ...
        /// <summary>
        /// Send a SuperHot game event to the daemon.
        /// </summary>
        public void SendEvent(string eventName, string hand = null, int priority = 0)
        {
            ...
            // Build JSON command
            var json = hand != null
                ? $"{{\"cmd\":\"superhot_event\",\"event\":\"{eventName}\",\"hand\":\"{hand}\",\"priority\":{priority}}}"
                : $"{{\"cmd\":\"superhot_event\",\"event\":\"{eventName}\",\"priority\":{priority}}}";
