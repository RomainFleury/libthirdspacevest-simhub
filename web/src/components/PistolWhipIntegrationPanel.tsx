...
export function PistolWhipIntegrationPanel() {
  const {
    status,
    isLoading,
    error,
  ...
  return (
    <div className="pistolwhip-panel">
        ...
        <div className="mod-info">
          <details>
            ...
            <div className="mod-details">
              <ol>
                <li>Install <a href="https://github.com/LavaGang/MelonLoader/releases" target="_blank" rel="noreferrer">MelonLoader 0.6.x</a> (for Il2Cpp games)</li>
                <li>Download <code>ThirdSpace_PistolWhip.dll</code></li>
                <li>Copy to <code>Pistol Whip/Mods/</code></li>
                <li>Start the daemon (port 5050)</li>
                <li>Launch Pistol Whip</li>
              </ol>
              <p className="note">
          ...
          <div className="events-log">
            {gameEvents.length === 0 ? (
              <div className="no-events">
                Waiting for events from Pistol Whip...
              </div>
            ) : (
