...
// Half-Life: Alyx Steam App ID
const ALYX_APP_ID = 546560;
// Steam URL to launch with -condebug option
const STEAM_LAUNCH_URL = `steam://run/${ALYX_APP_ID}//-condebug`;
      ...
      <div className="mb-4 space-y-3">
        <div className="flex flex-wrap gap-3">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-blue-600/80 to-blue-700/80 px-4 py-2 font-medium text-white transition hover:from-blue-600 hover:to-blue-700"
            title="Launch Half-Life: Alyx via Steam with -condebug option"
          >
            {/* Steam icon */}
            <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
        ...
        <p className="text-xs text-slate-500">
          💡 Click "Launch via Steam" to start Half-Life: Alyx with console logging enabled (<code className="bg-slate-800/50 px-1 rounded">-condebug</code>)
        </p>
      </div>
