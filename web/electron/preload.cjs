...
contextBridge.exposeInMainWorld("vestBridge", {
  ...
  mordhauStart: (logPath) => ipcRenderer.invoke("mordhau:start", logPath),
  mordhauStop: () => ipcRenderer.invoke("mordhau:stop"),
  mordhauStatus: () => ipcRenderer.invoke("mordhau:status"),
  ...
  l4d2Status: () => ipcRenderer.invoke("l4d2:status"),
    ...
    chivalry2BrowseLogPath: () => ipcRenderer.invoke("chivalry2:browseLogPath"),
    chivalry2GetSettings: () => ipcRenderer.invoke("chivalry2:getSettings"),
    chivalry2SetLogPath: (logPath) => ipcRenderer.invoke("chivalry2:setLogPath", logPath),
